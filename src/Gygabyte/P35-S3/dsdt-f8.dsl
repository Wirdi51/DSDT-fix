...
DefinitionBlock ("", "DSDT", 1, "GBT   ", "GBTUACPI", 0x00001000)
{
    ...
    Scope (\_GPE)
    {
        ...
        Method (_L0E, 0, NotSerialized)  // _Lxx: Level-Triggered GPE, xx=0x00-0xFF
        {
            ...
            Notify (\_SB.PWRB, 0x02) // Device Wake
            Notify (\_SB.PCI0.US31, 0x02) // Device Wake
            Notify (\_SB.PWRB, 0x02) // Device Wake
        }
    ...
    Scope (\_SB)
    {
            ...
            Device (\_SB.PCI0.PEX3.JMB0)
            {
                ...
                Device (SDE0)
                {
                    ...
                    Method (_GTM, 0, NotSerialized)  // _GTM: Get Timing Mode
                    {
                        ...
                        GTM3 = Local3
                        GTM4 = Local4
                        Return (IDEB) /* \_SB_.PCI0.PEX3.JMB0.IDEB */
                    }

                    Method (_STM, 3, NotSerialized)  // _STM: Set Timing Mode
                    {
                        IDEB = Arg0
                        Local0 = GTM0 /* \_SB_.PCI0.PEX3.JMB0.GTM0 */
                        Local1 = GTM1 /* \_SB_.PCI0.PEX3.JMB0.GTM1 */
                        Local2 = GTM2 /* \_SB_.PCI0.PEX3.JMB0.GTM2 */
                        Local3 = GTM3 /* \_SB_.PCI0.PEX3.JMB0.GTM3 */
                        Local4 = GTM4 /* \_SB_.PCI0.PEX3.JMB0.GTM4 */
                    ...
                    Device (DRV0)
                    {
                        ...
                        Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                        {
                            ...
                            PIOM = PMIO /* \_SB_.PCI0.PEX3.JMB0.PMIO */
                            PIOM |= 0x08
                            DMAM = PMDM /* \_SB_.PCI0.PEX3.JMB0.PMDM */
                            If ((MODP && 0x01))
                            {
                                DMAM |= 0x40
                            }
                    ...
                    Device (DRV1)
                    {
                        ...
                        Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                        {
                            ...
                            CreateByteField (Local0, 0x01, PIOM)
                            CreateByteField (Local1, 0x01, DMAM)
                            PIOM = PSIO /* \_SB_.PCI0.PEX3.JMB0.PSIO */
                            PIOM |= 0x08
                            DMAM = PSDM /* \_SB_.PCI0.PEX3.JMB0.PSDM */
                            If ((MODP && 0x04))
                            {
                                DMAM |= 0x40
                            }
                ...
                Device (SDE1)
                {
                    ...
                    Device (DRV0)
                    {
                        ...
                        Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                        {
                            ...
                            CreateByteField (Local0, 0x01, PIOM)
                            CreateByteField (Local1, 0x01, DMAM)
                            PIOM = SMIO /* \_SB_.PCI0.PEX3.JMB0.SMIO */
                            PIOM |= 0x08
                            DMAM = SMDM /* \_SB_.PCI0.PEX3.JMB0.SMDM */
                            If ((MODS && 0x01))
                            {
                                DMAM |= 0x40
                            }
                    ...
                    Device (DRV1)
                    {
                        ...
                        Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                        {
                            ...
                            CreateByteField (Local0, 0x01, PIOM)
                            CreateByteField (Local1, 0x01, DMAM)
                            PIOM = SSIO /* \_SB_.PCI0.PEX3.JMB0.SSIO */
                            PIOM |= 0x08
                            DMAM = SSDM /* \_SB_.PCI0.PEX3.JMB0.SSDM */
                            If ((MODS && 0x04))
                            {
                                DMAM |= 0x40
                            }
            ...
            Device (\_SB.PCI0.PEX3.JMB1)
            {
                ...
                Device (SDE0)
                {
                    ...
                    Method (_GTM, 0, NotSerialized)  // _GTM: Get Timing Mode
                    {
                        ...
                        GTM3 = Local3
                        GTM4 = Local4
                        Return (IDEB) /* \_SB_.PCI0.PEX3.JMB1.IDEB */
                    }

                    Method (_STM, 3, NotSerialized)  // _STM: Set Timing Mode
                    {
                        IDEB = Arg0
                        Local0 = GTM0 /* \_SB_.PCI0.PEX3.JMB1.GTM0 */
                        Local1 = GTM1 /* \_SB_.PCI0.PEX3.JMB1.GTM1 */
                        Local2 = GTM2 /* \_SB_.PCI0.PEX3.JMB1.GTM2 */
                        Local3 = GTM3 /* \_SB_.PCI0.PEX3.JMB1.GTM3 */
                        Local4 = GTM4 /* \_SB_.PCI0.PEX3.JMB1.GTM4 */
                        If (((Local0 != 0xFFFFFFFF) && (Local0 != 0x00)))
                        {
                            PMIO = Match (PIOT, MEQ, Local0, MTR, 0x00, 0x00)
                        }
                    ...
                    Device (DRV0)
                    {
                        ...
                        Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                        {
                            ...
                            CreateByteField (Local0, 0x01, PIOM)
                            CreateByteField (Local1, 0x01, DMAM)
                            PIOM = PMIO /* \_SB_.PCI0.PEX3.JMB1.PMIO */
                            PIOM |= 0x08
                            DMAM = PMDM /* \_SB_.PCI0.PEX3.JMB1.PMDM */
                            If ((MODP && 0x01))
                            {
                                DMAM |= 0x40
                            }
                    ...
                    Device (DRV1)
                    {
                        ...
                        Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                        {
                            ...
                            CreateByteField (Local0, 0x01, PIOM)
                            CreateByteField (Local1, 0x01, DMAM)
                            PIOM = PSIO /* \_SB_.PCI0.PEX3.JMB1.PSIO */
                            PIOM |= 0x08
                            DMAM = PSDM /* \_SB_.PCI0.PEX3.JMB1.PSDM */
                            If ((MODP && 0x04))
                            {
                                DMAM |= 0x40
                            }
                ...
                Device (SDE1)
                {
                    ...
                    Device (DRV0)
                    {
                        ...
                        Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                        {
                            ...
                            CreateByteField (Local0, 0x01, PIOM)
                            CreateByteField (Local1, 0x01, DMAM)
                            PIOM = SMIO /* \_SB_.PCI0.PEX3.JMB1.SMIO */
                            PIOM |= 0x08
                            DMAM = SMDM /* \_SB_.PCI0.PEX3.JMB1.SMDM */
                            If ((MODS && 0x01))
                            {
                                DMAM |= 0x40
                            }
                    ...
                    Device (DRV1)
                    {
                        ...
                        Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                        {
                            ...
                            CreateByteField (Local0, 0x01, PIOM)
                            CreateByteField (Local1, 0x01, DMAM)
                            PIOM = SSIO /* \_SB_.PCI0.PEX3.JMB1.SSIO */
                            PIOM |= 0x08
                            DMAM = SSDM /* \_SB_.PCI0.PEX3.JMB1.SSDM */
                            If ((MODS && 0x04))
                            {
                                DMAM |= 0x40
                            }
        ...
        Device (MEM)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateDWordField (BUF0, \_SB.MEM._CRS._Y0B._LEN, ASSM)  // _LEN: Length
